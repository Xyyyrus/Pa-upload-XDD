      ...
      <div className='bg-gray-300 flex justify-center '>
        ...
        >
          ...
          <img
            src={FacebookIcon}
            alt='User'
            className='w-15 h-10 m-2 cursor-pointer'
          />
        </button>
        <button
          className='flex items-center pr-3 focus:outline-none'
        ...
        >
          ...
          <img
            src={InstagramIcon}
            alt='User'
            className='w-15 h-12 m-2 cursor-pointer'
          />
        </button>
        ...
        <div className='flex'>
          ...
          <div className='flex justify-around w-full'>
            <div>
              ...
              {/* White divider line with margin */}
              <ul className='space-y-2'>
                ...
                <li>
                  <Link to='/trade-deals'>Trade Deals</Link>
                </li>
                <li>
                  <Link to='/'>Bidding Zone</Link>
                </li>
                <li>
                  <Link to='/'>Trade Events</Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className='space-y-2'>
                ...
                <li>
                  <Link to='/shop-now'>Fashion & Accessories</Link>
                </li>
                <li>
                  <Link to='/'>Home & Furniture</Link>
                </li>
                <li>
                  <Link to='/trade-deals'>Automobile & Motorcylces</Link>
                </li>
                <li>
                ...
                <li>
                  <Link to='/about'>Pet Supplies</Link>
                </li>
              </ul>
            </div>
            ...
            <div className='pt-10'>
              <ul className='space-y-2'>
                ...
                <li>
                  <Link to='/shop-now'>Shoes</Link>
                </li>
                <li>
                  <Link to='/'>Toys & Games</Link>
                </li>
                <li>
                  <Link to='/trade-deals'>Sports & Lifestyle</Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className='space-y-2'>
                <li>
                  <Link to='/'>sampl@gmail.com</Link>
                </li>
                <li>
                  <Link to='/shop-now'>sampl@gmail.com</Link>
                </li>
                <li>
                  <Link to='/'>+63 912 3456 789</Link>
                </li>
                <li>
                  <Link to='/trade-deals'>+63 911 0090 908</Link>
                </li>
              </ul>
            </div>
          </div>
